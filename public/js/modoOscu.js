/* window.onload = function(){
    ...
    //fin del fondo del header 

    let buscador = document.querySelector('.buscar input');
    buscador.style.backgroundColor = '#0b090a';
    
    //lupa del header
    let buscar = document.querySelector('.fa-search');
    buscar.style.color = '#0b090a';
    //fin de la lupa del header 
    
 /*
    let i = document.querySelector('type input');
  ...
  nav_list.style.color = '#a100f2';
  
  //lista del nav 
  let nav__listitemdrop = document.querySelector('.nav__listitemdrop');
  nav__listitemdrop.style.backgroundColor = '#0b090a';
    ...
    let col2linea = document.querySelector('.col2linea span');
    col2linea.style.color = '#a100f2';
    ...
    swiper.style.backgroundColor = '#0b090a';
     ...
     let separadorh3 = document.querySelector('H3');
     ...
     /* let SectionTittle = document.querySelector('.SectionTittle h3');
      SectionTittle.style.color = '#a100f2';  */
...
//funciona 
/*
let contenedorRegistro = document.querySelector('.containerregistro');
 contenedorRegistro.style.backgroundColor = '#0b090a'; 
...
//registro no funciona 
    ...
    logregistermain.style.backgroundColor = '#0b090a';
     ...
     let a_inicio = document.querySelector('.a_inicio');
     a_inicio.style.color = '#a100f2';
...
/*
     //sobre nosotros
     let sobreN = document.querySelector('.textSN');
     sobreN.style.backgroundColor = '#0b090a'; */
/*
     let tituloSN = document.querySelector('.tituloSN');
     tituloSN.style.color = 'azul'; 

     let textoSN = document.querySelector('.textoSN');
     textoSN.style.color = "azul"; */
